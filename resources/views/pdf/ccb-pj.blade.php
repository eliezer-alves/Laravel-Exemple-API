...
<body>
    ...
    <div style="width: 80%; margin: auto;" align="center">
        <table align="center" width="100%">
            <tr>
                <td colspan="3" width="100%" align="center" class="border" valign="top"><b>PARCELAS</b></td>
            </tr>
            <tr>
                <td width="33%" align="center" class="border" valign="top">
                    <h3>Parcela</h3>
                </td>
                <td width="33%" align="center" class="border" valign="top">
    ...
    <div align="center">
        <table align="center" width="100%">
            <tr>
                <td style="text-align: justify; font-size: 12px" width="100%">
    ...
    <table width="100%" style="margin-top: 20px; font-size: 10px;">
        <tr align="center" valign="center">
            <td width="5%"><img width="20px" src="<?= URL('assets/images/check.png') ?>"></td>
    ...
    <table width="100%" style="margin-top: 10px; font-size: 10px;">
        <tr align="center" valign="center">
            <td width="5%"><img width="20px" src="<?= URL('assets/images/check.png') ?>"></td>
            <td align="left" width="95%">
                APROVAÇÃO DE PROPOSTA COBUCCIO SOCIEDADE DE CRÉDITO DIRETO S.A, NOME FANTASIA ÁGIL, CNPJ: 36.947.229/0001-85 , assinou. E-mail: credito@agil.com.br - IP : <?php
    ...
    foreach ([] as $v) {
        $html  = '' .
            ...
            <tr align="center" valign="center">
                <td width="5%"><img width="20px" src="' . URL('assets/images/check.png') . '"></td>
                <td align="left" width="95%">
                    ASSINATURA – ' . $v->Nome . ' - VIA SISTEMA WEB ÁGIL, assinou em ' . $v->Data_Aceite . ', CPF: ' . $v->CPF . ', Celular: ' . $v->Celular . ', ' . $v->Email . ' - IP: ' . $v->IP_Cliente . ' - Hash: ' . $v->Hash . '
                </td>
            </tr>
        </table>';
    ...
    <table width="100%" style="margin-top: 10px; font-size: 10px;">
        <tr align="center" valign="center">
            <td width="5%"><img width="20px" src="<?= URL('assets/images/check.png') ?>"></td>
            <td align="left" width="95%">
                TESTEMUNHA 1 – DIEGO LUIZ TEIXEIRA – 016.296.656-30, diego@agil.com.br – IP: <?php
                                                                                                if (isset($retorno->IP_Servidor)) {
                                                                                                    echo $retorno->IP_Servidor;
                                                                                                } else echo " – ";
                                                                                                ?> - Hash: pendente
    ...
    <tr align="center" valign="center">
        <td width="5%"><img width="20px" src="<?= URL('assets/images/check.png') ?>"></td>
        <td align="left" width="95%">TESTEMUNHA 2 – ANDRÉ RODRIGUES DE SOUSA – 103.291.366-58 ,andre@agil.com.br IP: 54.207.72.198 - Hash: pendente</td>
    </tr>
</table> -->
    <table width="100%" style="margin-top: 10px; font-size: 10px;">
        <tr align="center" valign="center">
            <td width="5%"><img width="20px" src="<?= URL('assets/images/check.png') ?>"></td>
            <td align="left" width="95%">
                TESTEMUNHA 2 – CÉLIO ALVES DE OLIVEIRA JÚNIOR – 069.584.136-01, junior@agil.com.br – IP: <?php
                                                                                                            if (isset($retorno->IP_Servidor)) {
                                                                                                                echo $retorno->IP_Servidor;
                                                                                                            } else echo " – ";
                                                                                                            ?> - Hash: pendente
