...
class AlterarDadosPropostaAnaliseRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'proposta.id_status_analise_proposta' => ['required', 'numeric', 'exists:cad_status_analise_proposta,id_status_analise_proposta'],
            'proposta.id_log_analise' => ['required', 'numeric', 'exists:log_analise_manual,id_log_analise_manual'],
            ...
            'socios.*.id_pessoa_assinatura' => ['regex:/^[0-9]+$/u', 'exists:cad_pessoa_assinatura,id_pessoa_assinatura'],
            'socios.*.nome' => ['string'],
            ...
            'socios.*.tipo_pessoa_assinatura' => ['numeric', 'nullable'],
            'socios.*.situacao_empregaticia' => ['string', 'nullable'],
