(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_CadastroCliente_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["atividades"]))
});
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 px-5" },
    [
      _vm._m(0),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass:
            "lg:mr-32 md:mr-32 sm:mr-10 mx-1 mt-4 col-span-2 rounded-md p-2"
        },
        [
          _c(
            "h1",
            {
              staticClass:
                "mt-4 text-center text-3xl text-gradient bg-gradient-to-r from-gray-300 via-white to-gray-300 hover:bg-gradient-to-l hover:from-yellow-300 hover:to-green-600"
            },
          ...
          _c(
            "form",
            { staticClass: "w-full", attrs: { action: "/solicitar" } },
            [
              _c("div", { staticClass: "grid lg:grid-cols-4 gap-2" }, [
                ...
                _vm._m(2),
                _vm._v(" "),
                _c("div", { staticClass: "py-1 col-span-2" }, [
                  _c("span", { staticClass: "px-1 text-sm text-gray-300" }, [
                      ...
                      _vm._l(_vm.atividades, function(atividade) {
                        return _c(
                          "option",
                          {
                            ...
                            attrs: { value: "atividade.id_atividade_comercial" }
                          },
                          [
                            _vm._v(
                              "\n              " +
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "mx-auto lg:mt-32 md:mt-32 sm:mt-10 mt-10 col-span-1" },
      [
        _c("img", {
          staticClass: "w-60",
        ...
        _c(
          ...
          {
            staticClass:
              "mt-4 ml-5 text-3xl text-gradient bg-gradient-to-r from-gray-300 via-white to-gray-300 hover:bg-gradient-to-l hover:from-yellow-300 hover:to-green-600"
          },
          [_vm._v("\n      Capital de Giro\n    ")]
        )
      ]
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "py-1 col-span-1" }, [
      _c("span", { staticClass: "px-1 text-sm text-gray-300" }, [
        _vm._v("CNPJ")
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "py-1 col-span-2" }, [
      _c("span", { staticClass: "px-1 text-sm text-gray-300" }, [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "py-1" }, [
      _c("span", { staticClass: "px-1 text-sm text-gray-300" }, [_vm._v("UF")]),
      _vm._v(" "),
      _c(
        "select",
        {
        ...
        [
          ...
          _vm._v(" "),
          _c("option", { attrs: { value: "RJ" } }, [_vm._v("Rio de Janeiro")]),
          _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "flex flex-wrap justify-end" }, [
      _c(
        "button",
        {
          staticClass:
            "mt-2 text-center w-40 text-green-900 text-lg font-bold bg-gradient-to-r from-green-600 to-yellow-300 hover:bg-gradient-to-l hover:from-yellow-300 hover:to-green-600 p-3 rounded-md hover:bg-black"
        },
        [_vm._v("\n          Cadastrar\n        ")]
      )
    ])
