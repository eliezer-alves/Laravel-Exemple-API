 ...
 *
 */
class DebitosService extends AbstractConsultasService
{
    ...
    private function request($attributes, $urlServico)
    {
        ...
        $response = null;
        $url = "{$this->baseUrl}/debitos/{$urlServico}";
        ...
        if ($response->status() != 200) {
            Log::channel('gacConsultas')->critical("Débitos - Erro ao consultar endereço {$urlServico}.", $response->json());
