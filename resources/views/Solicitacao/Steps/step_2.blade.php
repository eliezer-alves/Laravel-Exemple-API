...
<fieldset id="fieldset_step_1">
  <h4>Atendimento<span>Fase 2 - 4</span></h4>
  ...
  <div class="form-row">
    <div class="form-group col-md-8">
      ...
      <input class="form-control" type="text" name="razaoSocial" id="razaoSocial_s2" placeholder="" readonly="">
    </div> 
    <div class="form-group col-md-4">
      <label>CNPJ: <span>*</span></label>
      <input class="form-control" type="text" name="cnpj_s2" id="cnpj_s2" placeholder="" readonly="">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-8">
      ...
      <input class="form-control" type="text" name="nomeFantasia" id="nomeFantasia_s2" placeholder="" readonly="">
    </div> 
    <div class="form-group col-md-4">
      <label>Inscrição Estadual: <span>*</span></label>
      <input class="form-control" type="text" name="inscricaoEstadual" id="inscricaoEstadual_s2" placeholder="">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input class="form-control" type="text" name="tipoEmpresa" id="tipoEmpresa_s2" placeholder="" readonly="">
    </div> 
    <div class="form-group col-md-4">
      <label>Ramo de Atividade: <span>*</span></label>
      <input class="form-control" type="text" name="ramoAtividade" id="ramoAtividade_s2" placeholder="" readonly="">
    </div>
    <div class="form-group col-md-4">
      <label>Rendimento Mensal: <span>*</span></label>
      <input class="form-control money_meia_boca" type="text" name="rendaMensalAtividade" id="rendaMensal_s2" placeholder="" value="1000">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      ...
      <input class="form-control cep" type="text" name="cepEmpresa" id="cepEmpresa" minlength="9" placeholder="" value="">
    </div> 

    <div class="form-group col-md-2">
      <label>UF: <span>*</span></label>
      <select class="form-control" name="ufEmpresa" id="ufEmpresa" readonly="">
        <?php
        foreach ([] as $v) {
          $selected = '';
    ...
    <div class="form-group col-md-4">
      ...
      <input class="form-control" type="text" name="cidadeEmpresa" id="cidadeEmpresa" placeholder="" value="" readonly="">
    </div>

    <div class="form-group col-md-4">
      <label>Bairro: <span>*</span></label>
      <input class="form-control" type="text" name="bairroEmpresa" id="bairroEmpresa" placeholder="" value="">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input class="form-control" type="text" name="enderecoEmpresa" id="enderecoEmpresa" placeholder="" value="">
    </div> 
    <div class="form-group col-md-2">
      <label>Número: <span>*</span></label>
      <input class="form-control somente_numeros" type="text" name="numeroEmpresa" id="numeroEmpresa" placeholder="" value="">
    </div>
    <div class="form-group col-md-4">
      <label>Complemento: <span>*</span></label>
      <input class="form-control" type="text" name="complementoEmpresa" id="complementoEmpresa" placeholder="" value="">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input class="form-control celular" type="text" name="telefoneEmpresa" id="telefoneEmpresa" placeholder="" value="">
    </div>
    <div class="form-group col-md-8">
      <label>e-mail: <span>*</span></label>
      <input class="form-control" type="email" name="emailEmpresa" id="emailEmpresa" placeholder="" value="">
    </div>
  </div>
