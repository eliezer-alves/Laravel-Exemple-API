      ...
      <div class="flex">
        <div class="w-1/4">
          <div class="relative mb-2">
            <div
              class="w-10 h-10 mx-auto bg-teal-700 rounded-full text-lg text-white flex items-center"
            >
          ...
          <div class="text-xs text-center md:text-base">Simulação</div>
        </div>
        ...
        <div class="w-1/4">
          ...
          <div class="text-xs text-center md:text-base">Empresa</div>
        </div>
        ...
        <div class="w-1/4">
          ...
          <div class="text-xs text-center md:text-base">Concluir</div>
        </div>
      </div>
      <slot></slot>
    </div>
