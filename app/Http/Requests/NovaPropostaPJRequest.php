...
class NovaPropostaPJRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'proposta.agencia_liberacao' => ['required', 'numeric', 'max:4'],
            'proposta.digito_agencia_liberacao' => ['required', 'numeric', 'max:2'],
            'proposta.conta_liberacao' => ['required', 'numeric', 'max:6'],
            'proposta.digito_conta_liberacao' => ['required', 'numeric', 'max:2'],
            ...
            'cliente.inscricao_estadual' => ['required', 'numeric', 'max:14'],
            ...
            'cliente.ano_faturamento' => ['required', 'numeric', 'size:4'],
