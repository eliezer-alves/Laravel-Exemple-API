        ...
        <div class="grid lg:grid-cols-12 md:grid-cols-12">
          ...
          >
            <div
              class="font-bold text-gray-600 text-xs leading-8 uppercase h-6 mx-2 mt-3"
            >
              <label for="renda_mensal_representante">Rendimento Mensal</label>
            </div>
            ...
            >
              Valor mínimo de R$
              {{
                $v.solicitacao.renda_mensal_representante.$params.minValue.min /
                100
              }},00.
            </div>
          </div>
      ...
      <div class="flex p-2 mt-4">
        ...
        <div class="flex-auto flex flex-row-reverse">
          <button
            ...
            class="text-base ml-2 hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-teal-700 bg-teal-600 text-teal-100 border duration-200 ease-in-out border-teal-600 transition"
          >
            Avançar
          </button>
