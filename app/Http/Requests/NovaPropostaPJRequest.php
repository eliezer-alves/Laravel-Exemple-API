...
class NovaPropostaPJRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cliente.rendimento_mensal' => ['required', 'numeric'],
            'cliente.faturamento_anual' => ['required', 'numeric'],
            'cliente.capital_social' => ['required', 'numeric'],
            'cliente.ano_faturamento' => ['required', 'numeric'],
            ...
            'socios.0.complemento' => ['string', 'nullable', 'between:0,50'],
            ...
            'socios.0.numero_documento_identidade' => ['required', 'string'],
